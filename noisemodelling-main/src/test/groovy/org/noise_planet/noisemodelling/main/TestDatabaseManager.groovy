...
import org.noise_planet.noisemodelling.main.database_manager.Add_Primary_Key
import org.noise_planet.noisemodelling.main.database_manager.Clean_Database
import org.noise_planet.noisemodelling.main.database_manager.Display_Database
import org.noise_planet.noisemodelling.main.database_manager.Drop_a_Table
import org.noise_planet.noisemodelling.main.database_manager.Table_Visualization_Data
import org.noise_planet.noisemodelling.main.database_manager.Table_Visualization_Map
...
class TestDatabaseManager extends JdbcTestCase {
    ...
    void testTableVisualizationMap() {
        ...
        def res = new Table_Visualization_Map().exec(connection,
                ["tableName": "receivers" ])
        assertTrue(res.contains("MULTIPOINT"))
    }
