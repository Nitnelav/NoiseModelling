...
class Import_OSM_BBBike implements ScriptI {

    String title = 'Clean and fence BBBike tables - https://extract.bbbike.org/'
    String description = 'Clean and fence BBBike tables - Convert shp folder from BBBike (https://extract.bbbike.org/) to BUILDINGS, GROUND AND ROADS tables. ' +
