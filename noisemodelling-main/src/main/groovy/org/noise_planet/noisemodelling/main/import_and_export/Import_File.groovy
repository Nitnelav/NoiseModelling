...
class Import_File implements ScriptI {

    String title = 'Import File'
    String description = 'Import file into the database. </br> Valid file extensions : (csv, dbf, geojson, gpx, bz2, gz, osm, shp, tsv). </br>'
