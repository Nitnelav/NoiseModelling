...
package org.noise_planet.noisemodelling.main.acoustic_tools

import org.h2gis.utilities.SFSUtilities
import org.h2gis.utilities.TableLocation
import org.h2gis.utilities.wrapper.ConnectionWrapper
import org.noise_planet.noisemodelling.main.utilities.BezierContouring
...
class Create_Isosurface implements ScriptI {

    String title = 'Create an isosurface from a NoiseModelling result table and its associated TRIANGLES table.'

    String description = 'Create an isosurface from a NoiseModelling result table and its associated TRIANGLES table. The Triangle vertices table must have been created using the WPS block <b> Receivers/Delaunay_Grid </b> . ' +
