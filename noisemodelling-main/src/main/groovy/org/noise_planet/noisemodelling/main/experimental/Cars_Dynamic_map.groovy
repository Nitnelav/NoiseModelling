...
import org.noise_planet.noisemodelling.main.utilities.PointNoiseMap
...
class Cars_Dynamic_map implements ScriptI {

    String title = 'Compute Dynamic NoiseMap'
    String description = 'Compute Dynamic NoiseMap from individual moving point sources'

    Map inputs = [databaseName      : [name: 'Name of the database', title: 'Name of the database', description: 'Name of the database. (default : h2gisdb)', min: 0, max: 1, type: String.class],
    ...
    Map outputs = [result: [name: 'result', title: 'Result', type: String.class]]
    ...
    String exec(Connection connection, input) {
        ...
        return "Calculation Done ! L_CARS_GEOM has been created !"
    }
