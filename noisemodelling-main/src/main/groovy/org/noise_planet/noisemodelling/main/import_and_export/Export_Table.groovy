...
class Export_Table implements ScriptI {

    String title = 'Export table'
    String description = 'Export table from the database to a local file. </br> Valid file extensions : (csv, dbf, geojson, gpx, bz2, gz, osm, shp, tsv).'
