...
class Random_Grid implements ScriptI {

    String title = 'Random Grid'
    String description = '[H2GIS] Calculates a random grid of receivers. Return a table named RECEIVERS'
