...
class Import_Activities implements ScriptI {

    String title = 'Import Matsim "facilities" file'
    String description = 'Import Matsim "facilities" file containing agents activities location.'
