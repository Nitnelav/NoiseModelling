...
class Traffic_From_Events implements ScriptI {

    String title = 'Import traffic data from Mastim simultaion output folder'
    String description = 'Read Mastim events output file in order to get traffic NoiseModelling input'
