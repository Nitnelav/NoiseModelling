...
class Building_Grid3D implements ScriptI {
    String title = 'Buildings Grid'
    String description = 'Generates receivers placed 2 meters from building facades at different levels of the building.' +
