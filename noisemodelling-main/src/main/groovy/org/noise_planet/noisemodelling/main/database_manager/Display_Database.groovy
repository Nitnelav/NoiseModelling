...
class Display_Database implements ScriptI {

    String title = 'Display the list of tables (and their attributes).'
    String description = 'Displays the list of tables that are in the database. ' +
