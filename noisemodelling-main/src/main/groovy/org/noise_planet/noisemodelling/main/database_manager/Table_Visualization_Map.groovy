...
package org.noise_planet.noisemodelling.main.database_manager
...
class Table_Visualization_Map implements ScriptI {

    String title = 'Diplay a table on a map.'
    String description = 'Display a table containing a geometric field on a map. </br> Technically, it groups all the geometries of a table and returns them in WKT OGC format. </br> Be careful, this treatment can be blocking if the table is large.'
