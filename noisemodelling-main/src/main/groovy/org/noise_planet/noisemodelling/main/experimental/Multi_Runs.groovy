...
class Multi_Runs implements ScriptI {

    String title = '000Compute MultiRuns.'
    String description = '000Compute MultiRuns. A ver...'
...
class MRComputeRaysOut extends ComputeRaysOut {
    ...
    double[] MRcomputeAttenuation(PropagationProcessPathData pathData, long sourceId, double sourceLi, long receiverId, List<MRPropagationPath> propagationPath) {
        if (pathData != null) {
