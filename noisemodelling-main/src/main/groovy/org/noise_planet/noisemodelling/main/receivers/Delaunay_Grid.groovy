...
class Delaunay_Grid implements ScriptI {

    String title = 'Delaunay Grid'
    String description = 'Calculates a delaunay grid of receivers based on a single Geometry geom or a table tableName of Geometries with delta as offset in the Cartesian plane in meters.'
