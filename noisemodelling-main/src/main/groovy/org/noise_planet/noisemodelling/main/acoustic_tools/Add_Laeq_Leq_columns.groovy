...
class Add_Laeq_Leq_columns implements ScriptI {

    String title = 'Add Leq and LAeq columns'
    String description = 'Add the columns Leq and LAeq to a table with octave band values from 63 Hz to 8000 Hz. </br> The columns of the table should be named HZ63, HZ125,..., HZ8000 with an HZ prefix that can be changed.'
