...
class Import_Folder implements ScriptI {

    String title = 'Import all files from a folder'
    String description = 'Import all files with a specified extension from a folder to the database. </br> Valid file extensions : (csv, dbf, geojson, gpx, bz2, gz, osm, shp, tsv). </br>'
