...
class Noise_level_from_traffic implements ScriptI {

    String title = 'Compute LDay,Levening,LNight,Lden from road traffic'
    String description = 'Compute Lday noise map from Day Evening Night traffic flow rate and speed estimates (specific format, see input details).' +
