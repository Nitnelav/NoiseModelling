...
class Import_OSM_Pbf implements ScriptI {

    String title = 'Import BUILDINGS, GROUND and ROADS tables from OSM'
    String description = 'Convert PBF file (https://wiki.openstreetmap.org/wiki/PBF_Format) to input tables. ' +
