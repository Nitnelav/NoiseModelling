...
class Receivers_From_Activities_Random implements ScriptI {

    String title = 'Chose a Random Receivers For Matsim Activities'
    String description = 'Chose the closest building for every Mastim Activity in an ACTIVITIES table, and then chose a random receiver previously generated around this building.'
