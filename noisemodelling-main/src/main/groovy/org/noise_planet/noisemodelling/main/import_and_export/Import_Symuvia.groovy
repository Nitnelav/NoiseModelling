...
package org.noise_planet.noisemodelling.main.import_and_export
...
class Import_Symuvia implements ScriptI {

    String title = 'Import File'
    String description = 'Import file into a database table (csv, dbf, geojson, gpx, bz2, gz, osm, shp, tsv)'

    Map inputs = [pathFile       : [name: 'Path of the input File', description: 'Path of the input File (including extension .csv, .shp, etc.)', title: 'Path of the input File', type: String.class],
    ...
    Map outputs = [tableNameCreated: [name: 'tableNameCreated', title: 'tableNameCreated', type: String.class]]
