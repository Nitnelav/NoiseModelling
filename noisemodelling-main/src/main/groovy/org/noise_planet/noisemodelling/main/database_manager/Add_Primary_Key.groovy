...
class Add_Primary_Key implements ScriptI {

    String title = 'Add primary key column or constraint'
    String description = 'Add a primary key column or add a primary key constraint to a column of a table. </br> ' +
