...
class Clean_Buildings_Table implements ScriptI{

    String title = 'Clean BUILDINGS Table'
    String description = 'Clean the BUILDINGS table, avoiding all overlapping areas and unclosed polygons. NoiseModelling propagation code does not support well intersecting polygons' +
