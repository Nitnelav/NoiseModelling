...
class Noise_From_Attenuation_Matrix implements ScriptI {

    String title = 'Noise Map From Attenuation Matrix'
    String description = 'Noise Map From Attenuation Matrix.' +
            '<br/>'
