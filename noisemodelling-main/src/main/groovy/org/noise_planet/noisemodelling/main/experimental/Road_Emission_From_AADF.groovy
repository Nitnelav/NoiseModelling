...
class Road_Emission_From_AADF implements ScriptI {

    String title = 'Compute Road Emission'
    String description = 'Compute Road Emission Noise Map from Estimated Annual average daily flows (AADF) estimates. ' +
    ...
    Map inputs = [databaseName      : [name: 'Name of the database', title: 'Name of the database', description: 'Name of the database (default : first found db)', min: 0, max: 1, type: String.class],
