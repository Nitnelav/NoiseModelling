...
class Change_SRID implements ScriptI {

    String title = 'Change or set SRID'
    String description = 'Transforms table from its original coordinate reference system (CRS) to the CRS specified by Spatial Reference Identifier (SRID). </br> If the table does not have an associated SRID, the new SRID is associated with the table.'
