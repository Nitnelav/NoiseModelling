...
class Table_Visualization_Data implements ScriptI {

    String title = 'Display first rows of a table.'
    String description = 'Display first rows of a table containing. ' +
