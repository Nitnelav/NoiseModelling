...
class Get_Rayz implements ScriptI {

    String title = 'Get all rays'
    String description = 'Get all rays between sources and receivers. It will keep the results in a Zip file.' +
    ...
    Map outputs = [result: [name: 'Result output string', title: 'Result output string', description: 'This type of result does not allow the blocks to be linked together.', type: String.class]]
    ...
    String exec(Connection connection, input) {
        ...
        for (String srcFile : srcFiles) {
            ...
            fis.close()
            boolean fileSuccessfullyDeleted = new File(working_dir + srcFile).delete()
