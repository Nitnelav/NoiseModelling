...
class Screen_to_building implements ScriptI{

    String title = 'Convert screens to building format.'
    String description = 'Convert the screens to the building format. A width of 10 cm will be defined. If you also give a building table, this WPS block allows you to merge the two layers together.' +
