...
class Sources_From_TimeString implements ScriptI {

    String title = 'Create a SOURCE table from imported MATSim tables'
    String description = 'Create a ROADS table from imported MATSim tables, for a specific timeString' +
