...
package org.noise_planet.noisemodelling.main.receivers
...
class Regular_Grid implements ScriptI {

    String title = 'Regular Grid'
    String description = 'Calculates a regular grid of receivers based on a single Geometry geom or a table tableName of Geometries with delta as offset in the Cartesian plane in meters.'
    ...
    String exec(Connection connection, input) {
        ...
        return "Process done. Table of receivers " + receivers_table_name + " created !"
    }
}