...
class Noise_level_from_source implements ScriptI {

    String title = 'Calculation of the Lden,LDay,LEvening,LNight map from the noise emission table'
    String description = 'Calculation of the Lden map from the road noise emission table (DEN format, see input details). </br> Tables must be projected in a metric coordinate system (SRID). Use "Change_SRID" WPS Block if needed. ' +
